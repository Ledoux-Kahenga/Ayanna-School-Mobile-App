...
@riverpod
FraisScolaireDao fraisScolaireDao(FraisSccolareDaoRef ref)  {
  final db = ref.watch(databaseProvider);
...
@riverpod
JournalComptableDao journalComptableDao(
  JournalComptableDaoRef ref,
)  {
  final db = ref.watch(databaseProvider);
...
@riverpod
EcritureComptableDao ecritureComptableDao(
  EcritureComptableDaoRef ref,
)  {
  final db = ref.watch(databaseProvider);
